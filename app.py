...
# sqlalchemy config - configure postgres database details
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:4201@localhost:5432/dropdown'
...
class Carbrands(db.Model):
    ...
    def __repr__(self):
        ...
        return '\n brand_id:  brand_name: '.format(self.brand_id, self.brand_name)
...
class Carmodels(db.Model):
    ...
    def __repr__(self):
        ...
        return '\n model_id:  brand_id:  car_model: '.format(self.model_id, self.brand_id, self.car_model)
